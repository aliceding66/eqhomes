            ...
            <header class="container" id="head">
                ...
                <nav class="navbar navbar-default" role="navigation">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/images/eqhomeslogo.png" alt="eQ Homes Ottawa"/></a>
                    </div>
                    <div class="top-nav visible-lg">
                        ...
                        <a href="<?php echo esc_url(home_url('/')); ?>virtualtour"><span class="btn-virtualtour">VIRTUAL TOURS</span></a>
