            ...
            <div class="col-md-9 rightcolumn col-md-push-3">
                ...
                <ul id="mobileNavCommunity" class="navcommunity hidden-md hidden-lg">
                    ...
                    <?php if (get_field('show_the_resident_clubhouse')): ?>
                        ...
                        ?>"><a href="<?php echo get_permalink() ?>the_resident_clubhouse/">eQuinelle RESIDENT CLUB</a></li>
                        <?php endif; ?>
...
?>
                ...
                <?php if ($current_fp == 'floorplans') { ?>
                    ...
                    $rangeMax = isset($_REQUEST['rangeMax']) ? $_REQUEST['rangeMax'] : 2000000;
                    ...
                    <div class="row propertyList communityList">
                        ...
                        <?php while ($my_query->have_posts()) : $my_query->the_post(); ?>
                            ...
                            $sqft =  0 + trim(get_post_meta($post->ID, "_eqh_startsize", true));
                            ...
                            for ($t = 0; $t < count($lots); $t++) {
                                ...
                                if (in_array($slug, $lot_slugs)) {
                                    ...
                                    if($listingsposts[$c][$sqft]){
                                        $listingsposts[$c][$sqft+1] = $post;
                                    }else{
                                        $listingsposts[$c][$sqft] = $post;
                                    }
                                }
                            }
                        ...
                        if (count($listingsposts) > 0):
                            foreach ($listingsposts as $key => $value) {
                                if (count($value) > 0) {
                                    ...
                                    <h3 class="columnheader black <?=$key?>">
                                        <?php //echo $current_community_name . " - " . $key; ?>
...
//                                            $post = $value[$m];
                                        ...
                                        foreach ($value as $sqft => $post) {
                                            ...
                                            ?>
                                            <!-- property -->
                                            <div class="col-lg-4 col-sm-6 col-xs-12 plisting propertySingle sqft<?=$sqft?>">
                                                <div class="property">
                                                    <h4><?php echo strtoupper($post->post_title); ?><?php edit_post_link(__('Edit', 'eq_homes'), '<div class="edit">', '</div>'); ?></h4>
                                                    ...
                                                    <p>
														...
														if($current_community_name == "The Legends"){
                ...
                <?php if ($current_fp == 'amenities') { ?>
                    ...
                    <div class='col-md-6'><a class="btn btn-black pull-right" type="button" href="<?php echo get_field("download"); ?>" target="_blank">Download  Amenities Map</a></div>
                ...
                <?php if ($current_fp == 'contact') { ?>
                    ...
                    <div class="row">
                        <div class="col-md-4"><strong>Sales Office</strong><br>
                            ...
                            <?php echo get_post_meta($post->ID, "_eqh_city", true) . ", " . get_post_meta($post->ID, "_eqh_province", true) . " " . get_post_meta($post->ID, "_eqh_zip", true) . "<br>"; ?></div>
                        <div class="col-md-4">
                            <div>
...
// check if the repeater field has rows of data
            ...
            <div class="col-md-3 leftcolumn col-md-pull-9">
                ...
                <?php if (get_field('show_contact')and $current_fp != 'contact'): ?>
                    ...
                    <?php if ($current_fp != 'contact') { ?>
                        ...
                        <div><?php echo get_post_meta($post->ID, "_eqh_address", true) . "<br>"; ?>
                            <?php echo get_post_meta($post->ID, "_eqh_city", true) . ", " . get_post_meta($post->ID, "_eqh_province", true) . ", " . get_post_meta($post->ID, "_eqh_zip", true) . "<br>"; ?>
                ...
                <?php if (get_field('show_register')): ?>
                    ...
                    <div>
                        ...
                        <form method="post" id="side-contact-form" name="side-contact-form">
                            ...
                            <?php wp_nonce_field('register-nonce', 'registerme'); ?>* required
                            <button type="submit" class="btn btn-primary pull-right" id="side-contact-submit-btn" name="side-contact-submit-btn">Send</button>
                        </form>
                ...
                <?php endif; ?>
				 ...
				 <?php if (get_field('google_conversion_tag')): ?>
						<script>
						<?php echo get_post_meta($post->ID, "google_conversion_tag", true); ?>
						</script>
				 <?php endif; ?>
