                    ...
                    <tr>
                        ...
                        if (!empty($terms)) {
                            ...
                            foreach ((array) $terms as $term) {
                                ...
                                $list_terms.="<li><a href='#' onClick='quicksearch(\"" . $term->slug . "\");return false;'>" . $term->name . "</a></li>";
                                echo "<td width=\"16%\"><a href='#' onClick='quicksearch(\"" . $term->slug . "\");return false;'>" . $image . "<br>" . $term->name . "</a></td>";
                            }
                            //print "\n" . '</div>';
                        }
                        ?>
...
//echo($terms[0]->slug).'<br><br>';
                ...
                foreach ($listingsposts as $key => $value) {
                    ...
                    if (count($value) > 0) {
                       // echo "KEY: " . $key;
                        ...
                        <h3 class="columnheader black"><?php
            $theCommID = get_page_by_title($key, "OBJECT", 'community')->ID;

            echo $key . " : " . get_post_meta($theCommID, "_eqh_town", true);
                        ?></h3>
                        <div class="row">
                            <?php
                            for ($m = 0; $m < count($value); $m++) {
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-xs-12 plisting">
                                        <div class="property">
                                            <h4><?php echo $post->post_title; ?><?php edit_post_link(__('Edit', 'eq_homes'), '<div class="edit">', '</div>'); ?></h4>
                                            <?php //var_dump(get_post_meta($post->ID, "_eqh_home_community", true)); ?>
                                            <a href="<?php echo $post->permalink . sanitize_title($key) . '/floorplan' ?>">
                                                <?php $image = get_field("listing_feature_image"); //var_dump($image)         ?>
        ...
        <div class="col-md-3 leftcolumn col-md-pull-9">
            ...
            <?php get_search_form(); ?>
            <h3 class="columnheader green">SEARCH ALL HOMES</h3>
